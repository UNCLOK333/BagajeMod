...
namespace BagajeMod.Content.Items.Placeable.Furniture
{
    public class TerryRelic : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Furniture.TerryRelic>(), 0);
