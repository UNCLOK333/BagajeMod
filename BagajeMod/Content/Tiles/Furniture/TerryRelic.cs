...
namespace BagajeMod.Content.Tiles.Furniture
{
    ...
    public class TerryRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "BagajeMod/Content/Tiles/Furniture/TerryRelic";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "BagajeMod/Content/Tiles/Furniture/RelicPedestal";
