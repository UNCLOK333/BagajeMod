...
{
    public class CacaChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<Items.Placeable.FurnitureCaca.CacaChest>(), 1);
		...
		*/
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            else
            {
                if (isLocked)
                {
                    ...
                    int key = ModContent.ItemType<Items.Placeable.FurnitureCaca.ExampleChestKey>();
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.Placeable.FurnitureCaca.CacaChest>();
